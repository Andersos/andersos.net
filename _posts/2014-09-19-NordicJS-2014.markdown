...
category: posts
---
# [NordicJS 2014](http://nordicjs.com/)
Write something about the trip, destination and the conference.

## If you just want the slides you can get them here
...
[(Slides)]()
[(Video)]()  
Talk: Short talk showing that she made a relative keytar in Node.js.
Most of the talk is about people playing on it.
...
[(Video)]()  
Talk: She talked about how to use the [Dropbox](https://www.dropbox.com/) API.

### ["Style Guide Driven UI Design"](https://speakerdeck.com/jina/living-design-systems)
Speaker: [Jina Bolton](https://twitter.com/jina)
[(Slides)]()
[(Video)]()  
Talks: We do styleguies.
Would have been nice to hear her talk about how designers and front-end can work better together.
Or have her talk about tips or lessons learned about doing styleguides.
Single source of truth. [Theo](https://github.com/salesforce-ux/theo)
...
[Video]()  
Talk: I think this was todays best keynote. It was about testing and lessons learned.
